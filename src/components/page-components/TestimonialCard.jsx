...
export default function TestimonialCard({ img, fullName="Full Name", jobTitle="Job Title", twitterHandle="Twitter Handle", text="Text", ratingStarts}) {
    ...
    {[...Array(5)].map((start,index) => {
        ...
        return (
            <label key={index} htmlFor="rating" onClick={() => setRating(ratingValue)} style={{cursor:"pointer", color:"gold", fontSize:"1.5rem"}}>
